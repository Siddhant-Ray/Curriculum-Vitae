...
\item Task-specific fine-tuning phases to leverage learnt behaviour, make quicker, better forwarding decisions.
\end{itemize}
}}
...
\item Super-Node combines a traditional L3 router's control plane (CP) with a P4 programmable data plane (DP).
...
\item Created a new statistical algorithm to reduce class label redundancy the dataset classes.
\item Demonstrated improvements of the classification model based on the algorithm's reduction.
\end{itemize}
}}
